...
public class WindowsShortcut
{
	...
	public static void main(String[] args) throws IOException, ParseException {
		String shortLink = "C:\\Users\\huangqiqing\\Desktop\\工作日志.txt.lnk";
		WindowsShortcut shortCut = new WindowsShortcut(new File(shortLink));
		String targetPath = shortCut.getWorkingDirectory() + File.separator + shortLink.substring(shortLink.lastIndexOf(File.separator)+1, shortLink.lastIndexOf(".lnk"));
